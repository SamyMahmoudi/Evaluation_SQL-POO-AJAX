        ...
        <section id="profil-section">
            ...
            <div class="modif-profil">
                ...
                <form class="modif-tool" method="POST">
                    ...
                    <input type="text" name="new-user_name" id="" maxlength="20"
                ...
                <form class="modif-tool pass-modif" method="POST">
                    ...
                    <input type="password" name="new-user_password" maxlength="20" id="new-user_password"
                        placeholder="Nouveau mot de passe">
                    <input type="password" name="confirm_new-user_password" maxlength="20"
                        id="confirm_new-user_password" placeholder="confirmer nouveau mdp">
